local whitelistweps = {
	...
	["weapon_sib_m14"] = true,
	["weapon_sib_beretta"] = true,
	["weapon_sib_deagle"] = true,
	["weapon_sib_glock"] = true,
	["weapon_sib_usp"] = true,
	["weapon_sib_usp-s"] = true,
	["weapon_sib_m1911"] = true,
	["weapon_sib_pm"] = true,
	["weapon_sib_p226"] = true,
...
local ZenBool = false
net.Receive("ZenFix1", function (len, ply)
	ZenBool = net.ReadBool()
end)

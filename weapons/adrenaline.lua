...
SWEP.Author = "use this and kill all with knife!"
SWEP.Purpose = "Your adrenalin on maximum"
SWEP.Slot = 3
SWEP.SlotPos = 3
SWEP.Spawnable = true
SWEP.Category = "[HG] Medicine"
SWEP.ViewModel = "models/items/w_eq_adrenaline.mdl"
SWEP.WorldModel = "models/items/w_eq_adrenaline.mdl"
SWEP.UseHands = true
